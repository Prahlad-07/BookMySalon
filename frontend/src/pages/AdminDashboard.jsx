...
const statCardClass = 'card-base rounded-2xl p-6';
...
export default function AdminDashboard() {
  ...
  const stats = useMemo(() => {
    ...
    const bookingsBySalon = bookings.reduce((accumulator, booking) => {
      accumulator[booking.salonId] = (accumulator[booking.salonId] || 0) + 1;
      return accumulator;
    }, {});
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
          <div className={statCardClass}>
            ...
            <p className="text-3xl font-bold text-slate-900">{salons.length}</p>
          </div>
          <div className={statCardClass}>
            <div className="flex items-center justify-between text-slate-600 mb-3">
